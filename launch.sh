...
aws rds create-db-instance-read-replica Project1readonly --db-instance-identifier Project1readonly --source-db-instance-identifier Project1db --db-instance-class db.t2.micro 
