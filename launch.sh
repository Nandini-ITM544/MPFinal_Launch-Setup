...
aws rds create-db-instance-read-replica --db-instance-identifier project1readonly --source-db-instance-identifier Project1db --db-instance-class db.t2.micro --allocated-storage 20
