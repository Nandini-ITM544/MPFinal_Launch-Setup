...
aws elb create-lb-cookie-stickiness-policy --load-balancer-name Project1 --policy-name StickyPloicy
aws elb set-load-balancer-policies-of-listener --load-balancer-name Project1 --policy-name StickyPloicy --load-balancer-port 80
...
aws rds create-db-instance --db-name Project1db --db-instance-identifier Project1db --db-instance-class db.t2.micro --engine MySql --allocated-storage 20 --master-username nandini --master-user-password nandinipwd --backup-retention-period 1
aws rds wait db-instance-available --db-instance-identifier project1db
...
aws rds wait db-instance-available --db-instance-identifier project1readonly